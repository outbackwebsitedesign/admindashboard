  ...
  return sth('div', { className: 'col', style: { gap: 16 } },
    sth(StCard, { title: 'Invoicing & tax' },
      sth('div', { className: 'row', style: { gap: 12, marginBottom: 14 } },
        ...
        sth('div', { className: 'form-row', style: { flex: 1, marginBottom: 0 } }, sth('label', null, 'Default payment terms (days)'),
          sth('select', { className: 'input mono', value: terms, onChange: e => setTerms(e.target.value) },
            window.PAYMENT_TERMS_OPTIONS.map(d => sth('option', { key: d, value: String(d) }, 'Net ' + d))))),
      sth('div', { className: 'row', style: { gap: 12, marginBottom: 14 } },
        ...
        sth('div', { className: 'form-row', style: { flex: 1, marginBottom: 0 } }, sth('label', null, 'Currency'), sth('input', { className: 'input', defaultValue: window.CURRENCY_LABEL, readOnly: true }))),
      sth('div', { className: 'row', style: { gap: 12, marginBottom: 14 } },
